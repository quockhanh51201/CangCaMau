...
const DetailAskScreen = ({route, navigation}) => {
    ...
    <View style={{flex: 1}}>
      ...
      <ScrollView>
        <View
          ...
          <TextInputCusTom lable={'Tên tàu'} text={item.name} />
          <TextInputCusTom lable={'Nội dung ý kiến'} text={item.note} />
        </View>
        <Text
          style={{
...
export default DetailAskScreen;
