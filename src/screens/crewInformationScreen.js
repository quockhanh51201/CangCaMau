...
const CrewInformationScreen = ({navigation}) => {
  ...
  return (
    <View style = {{flex: 1}}>
    <HeaderComponents label={'Thông tin thuyền viên'} navigation={navigation} colorIcon={'#333'}/>
    ...
    <ScrollView>
        <View style = {{flex: 1, marginLeft: 12, marginRight: 12}}>
            ...
            <View style = {{
                ...
                <TextInputCusTom lable={'Giấy chứng nhận chuyên môn'} right={'Clear'}/>
            ...
            {/* ========= */}
            <View style = {{ flexDirection: 'row',justifyContent: 'space-between', alignItems: 'center', marginTop: 20, marginBottom: 37 }}>
                <View style = {{width: 173}}>
                    <TouchableOpacityComponent3 content={'Đóng'} color={'#828282'} backgroundColor={'#FFF'} onPress={() => navigation.goBack()}/>
                </View>
                <View style = {{width: 173}}>
                    <TouchableOpacityComponent3 content={'Cập nhật'} color={'#FFF'} backgroundColor={'#005F94'}/>
                </View>
            </View>
        </View>
    </ScrollView>
