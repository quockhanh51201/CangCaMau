...
const DetailCrewScreen = ({navigation}) => {
  ...
  return (
    <View style = {{flex: 1}}>  
        ...
        <HeaderComponents navigation={navigation} label={'Thông tin thuyền viên'} colorIcon={'#333'}/>
        <View style ={{justifyContent: 'center', alignItems: 'center'}}>
            <Image source={IMAGES.avt} resizeMode='contain' style = {{width: 80, height: 80}}/>
            <View style ={{width: 66, height: 16, borderRadius: 2, backgroundColor: '#4DBFFF', alignItems: 'center', marginTop: 7}}>
                <Text style = {{fontFamily: 'Inter-Regular', fontSize: 10, color: '#FFF'}}>Rạng đông 1</Text>
            </View>
        </View>
        <ScrollView>
            ...
            <View style = {{marginTop: 20, marginBottom: 30,alignItems: 'center'}}>
                <View style = {{width: 173}}>
                    <TouchableOpacityComponent3 content={'Cập nhật'} backgroundColor={'#005F94'} color={'#FFF'} onPress={() => navigation.navigate('UpdateDetailCrewScreen')}/>
                </View>
            </View>
        </ScrollView>
    </View>
...
export default DetailCrewScreen