    ...
    return(
        <ImageBackground source={IMAGES.background2} style={{flex:1}} resizeMode="stretch">
            ...
            <ScrollView style={{flex: 1}}>
                ...
                >
                    <TextInputComponent placeholder={'Mật khẩu mới'} secureTextEntry={true}/>
                    <TextInputComponent placeholder={'Nhập lại mật khẩu mới'} secureTextEntry={true}/>
                </View>
                <View
                    style = {{
                        margin: 48,
                ...
                >
                    <TouchableOpacityComponents content={'Đổi mật khẩu'} onPress={() => navigation.navigate('Login')}/>
                </View>
