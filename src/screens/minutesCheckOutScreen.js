    ...
    return (
        <View style = {{flex: 1, marginLeft: 12, marginRight: 12}}>
            ...
            <ScrollView>
                ...
                <Title title={'4. Kiểm tra thực tế(Check chọn nếu đủ (Đ), không check nếu thiếu (T))'} icon={true}/>
                ...
                <TitleChild title={'4.2 Loại nghề khai thác thủy sản và đánh dấu tàu cá'}/>
                <View style = {{
                    borderRadius: 6,
                    backgroundColor: '#FFF',
                    paddingTop: 5,
                ...
                <View style = {{
                    ...
                    <TextInputCusTom lable={'Số lượng thuyền viên tàu cá'} placeholder={'--'}/>
                </View>
                <Title title={'5. Đã nộp báo cáo, nhật ký khai thác chuyến trước'} icon={true}/>
                <View style = {{
                    borderRadius: 6,
                    backgroundColor: '#FFF',
                    paddingTop: 5,
                ...
                <View style = {{justifyContent: 'center', alignItems: 'center', marginTop: 20, marginBottom: 37 }}>
                    <View style = {{width: 173}}>
                        <TouchableOpacityComponent3 content={'Đóng'} color={'#333333'} backgroundColor={'#FFF'} onPress={() => navigation.navigate('OutScreen')}/>
                    </View>
                </View>
            </ScrollView>
        </View>
