      ...
      <ScrollView>
        ...
        {detailOut || (
          <>
            ...
            <TouchableOpacity
              onPress={() => navigation.navigate('CheckOutNocationScreen')}>
              <View
                style={{
                  marginRight: 12,
                  marginLeft: 12,
                ...
                <Text
                  ...
                  Phiếu thông báo tàu cá xuất cảng
                </Text>
                <View
                  style={{
                    height: 12,
            ...
            <TouchableOpacity
              onPress={() => navigation.navigate('MinutesCheckOutScreen')}>
              <View
                style={{
                  marginRight: 12,
                  marginLeft: 12,
        ...
        {detailIn || (
          <>
            ...
            <TouchableOpacity
              onPress={() => navigation.navigate('CheckInNocationScreen')}>
              <View
                style={{
                  marginRight: 12,
                  marginLeft: 12,
            ...
            <TouchableOpacity
              onPress={() => navigation.navigate('MinutesCheckInScreen')}>
              <View
                style={{
                  marginRight: 12,
                  marginLeft: 12,
