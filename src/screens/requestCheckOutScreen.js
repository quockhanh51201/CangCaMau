...
const RequestCheckOutScreen = ({navigation}) => {
    const [modalVisible, setModalVisible] = useState(false);
    return (
        <View style ={{flex: 1}}>
            <HeaderComponents label={'Yêu cầu xuất bến'} colorIcon={'#333'} navigation={navigation}/>
            <ScrollView>
                <TouchableOpacity>
                    <View style = {{
                        borderRadius: 6,
                ...
                <View style = {{
                    ...
                    <View style = {{flex: 1, marginLeft: 2.5}}>
                        <TouchableOpacityComponent3 content={'Yêu cầu xuất bến'} color={'#FFF'} backgroundColor={'#FD397A'} onPress={() => setModalVisible(true)}/>
                    </View>
                </View>
            </ScrollView>
            <Modal
                ...
                <View style = {{
                    ...
                    <View style = {{
                        ...
                        <View style ={{marginTop: 50, marginRight: 12, marginLeft: 12, marginBottom: 37, flexDirection: 'row'}}>
                            ...
                            <View style = {{flex: 1, marginLeft: 2.5}}>
                                <TouchableOpacityComponent3 content={'Xác nhận'} color={'#FFF'} backgroundColor={'#FD397A'}/>
                            </View>
                        </View>
                    </View>
                </View>
...
export default RequestCheckOutScreen