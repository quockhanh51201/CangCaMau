...
const ViolationHistoryScreen = ({navigation}) => {
  ...
  const ListViolation = ({data, navigation}) => {
    return (
      <FlatList
        data={data}
          ...
          return (
            <View style={{flexDirection: 'row', flex: 1}}>
              ...
              <View
                ...
                <TouchableOpacity
                  onPress={() => navigation.navigate('DetailViolationScreen')}>
                  <View>
  ...
  return (
    <View style={{flex: 1}}>
      ...
      <HeaderComponent4 label={'Lịch sử vi phạm'} navigation={navigation} />
      {violation.length === 0 ? (
        <View
          style={{
            flex: 1,
        ...
        <View style={{flex: 1}}>
          <ScrollView>
            <ListViolation data={violation} navigation={navigation} />
          </ScrollView>
        </View>
      )}
    </View>
