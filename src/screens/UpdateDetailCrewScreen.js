...
const TextInputCusTom = ({lable, text, setText, keyboardType, right, onPress}) => {
    return(
        <View
            style ={{
                height: 55,
...
const IconCalendar = ({onPress}) => {
    return (
        <TouchableOpacity onPress={onPress}>
            <View>
                <Image source={ICONS.Calendar} style = {{width: 16, height: 16}} resizeMode='contain'/>
            </View>
        </TouchableOpacity>
    )
}
...
const UpdateDetailCrewScreen = ({navigation}) => {
        ...
        >
            <View style = {{
                ...
                <View style = {{
                    ...
                    <Text style = {{color: '#333', fontFamily: 'Roboto-Bold', fontSize: 18, marginTop: 30}}>Xác nhận đóng</Text>
                    ...
                    <View style ={{marginTop: 50, marginRight: 12, marginLeft: 12, marginBottom: 37, flexDirection: 'row'}}>
                        <View style = {{flex: 1, marginRight: 2.5}}>
                            <TouchableOpacityComponent3 content={'Đóng'} color={'#828282'} backgroundColor={'#F5F5F5'} onPress={() => setModalVisiblePopUp(false)}/>
                        </View>
  ...
  return (
    <View style = {{flex: 1}}>  
        ...
        <HeaderComponents navigation={navigation} label={'Cập nhật thông tin thuyền viên'} colorIcon={'#333'}/>
        <View style ={{justifyContent: 'center', alignItems: 'center', marginBottom: 10}}>
            <Image source={IMAGES.avt} resizeMode='contain' style = {{width: 80, height: 80}}/>
        </View>
        <ScrollView>
            <View style = {{flex: 1 , borderRadius: 10, marginLeft: 12, marginRight: 12, marginTop: 10, backgroundColor: '#FFF', paddingLeft: 12, paddingRight: 12}}>
                <TextInputCusTom lable={'Họ và tên'} right={'Clear'}/>
                <TextInputCusTom lable={'CCCD/CMND'} right={'Clear'}/>
                <TextInputCusTom lable={'Ngày sinh'} right={'Calendar'} onPress={() => setModalVisible(!modalVisible)}/>
            ...
            <View style = {{flex: 1 , borderRadius: 10, marginLeft: 12, marginRight: 12, marginTop: 20, backgroundColor: '#FFF', paddingLeft: 12, paddingRight: 12}}>
                <TextInputCusTom lable={'Giấy chứng nhân chuyên môn'} right={'Clear'}/>
                <TextInputCusTom lable={'Cơ quan cấp'} right={'Clear'}/>
                <TextInputCusTom lable={'Ngày cấp'} right={'Calendar'} onPress={() => setModalVisible(!modalVisible)}/>
            </View>
            <View style = {{marginTop: 20, marginBottom: 30,alignItems: 'center', flexDirection: 'row', justifyContent: 'space-around'}}>
                <View style = {{width: 173}}>
                    <TouchableOpacityComponent3 content={'Đóng'} backgroundColor={'#FFF'} color={'#828282'} onPress={() => navigation.goBack()}/>
                </View>
                <View style = {{width: 173}}>
                    <TouchableOpacityComponent3 content={'Cập nhật'} backgroundColor={'#005F94'} color={'#FFF'} onPress={() => setModalVisiblePopUp(true)}/>
                </View>
                <PopUp/>
            </View>
        </ScrollView>
