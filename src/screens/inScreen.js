...
const InScreen = ({navigation}) => {
    return (
        <View style ={{flex: 1}}>
            <HeaderComponents label={'00776 - Thái học 2'} colorIcon={'#333'} navigation={navigation}/>
            <ScrollView>
                <TouchableOpacity>
                    <View style = {{
                        borderRadius: 6,
                ...
                <View style = {{
                    ...
                    <TouchableOpacityComponent3 content={'Xuất bến'} color={'#FFF'} backgroundColor={'#FD397A'} onPress={() => navigation.navigate('RequestCheckOutScreen')}/>
                </View>
            </ScrollView>
        </View>
    )
