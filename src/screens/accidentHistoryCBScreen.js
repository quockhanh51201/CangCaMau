  ...
  return (
    <FlatList
      ...
      renderItem={({item, index}) => (
        <TouchableOpacity
          onPress={() => navigation.navigate('DetailAccidentCBScreen')}>
          <View
            style={{
              paddingBottom: 15,
              paddingTop: 15,
            ...
            <Text
              ...
              Thời gian tai nạn: {item.thoiGianBiBat}
            </Text>
            <Text
              style={{
                color: '#ADADAD',
...
const History = () => {};
const AccidentHistoryCBScreen = ({navigation}) => {
  const [filterList, setFilterList] = useState(false);
  const [page, setPage] = useState('List');
  const [right, setRight] = useState('search');
  ...
  return (
    <View style={{flex: 1}}>
        ...
        {filterList ? (
          <>
            <View
              ...
              <TouchableOpacity
                onPress={() => navigation.navigate('FilterAccidentCBSceen')}>
                <View
                  style={{
                    flexDirection: 'row',
                    borderRadius: 4,
      ...
      <View style={{position: 'absolute', right: 12, bottom: 35}}>
        <TouchableOpacity
          onPress={() => navigation.navigate('AddAccidentCBScreen')}>
          <Image
            source={ICONS.Add}
            resizeMode="contain"
...
export default AccidentHistoryCBScreen;
