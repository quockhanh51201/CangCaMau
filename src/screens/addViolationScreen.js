    ...
    <View style={{flex: 1}}>
      ...
      <ScrollView>
        <View
          ...
          <TextInputCusTom lable={'Tên tàu'} right={'Clear'} />
          <TextInputCusTom
            lable={'Thời gian bị bắt'}
            right={'Calendar'}
            onPress={() => setModalVisible(!modalVisible)}
          />
          <TextInputCusTom lable={'Số thuyền viên hiện hữu'} right={'Clear'} />
        </View>
        <View
          style={{
            flex: 1,
          ...
          <TextInputCusTom lable={'Lực lượng bắt'} right={'Clear'} />
          <TextInputCusTom lable={'Khu vực bị bắt'} right={'Clear'} />
          <TextInputCusTom lable={'Đơn vị xử lý'} right={'Drop'} />
        </View>
        <View
          style={{
            flex: 1,
          ...
          <TextInputCusTom lable={'Lí do bị bắt'} right={'Clear'} />
          <TextInputCusTom lable={'Hình thức xử lý'} right={'Clear'} />
          <TextInputCusTom lable={'Ghi chú'} right={'Clear'} />
        </View>
        <View
          style={{
            marginRight: 12,
