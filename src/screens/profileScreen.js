import { Image, StatusBar, Text, Touchable, TouchableOpacity, TouchableOpacityComponent, View } from "react-native"
        ...
        return (
            <TouchableOpacity onPress = {onpress}>
                <View style = {{
                    ...
                    <Image source={ICONS.Next} resizeMode="contain" style = {{
                        flex: 1
                    }}/>
                </View>
            </TouchableOpacity>
            ...
            <View style = {{
                ...
                <TouchableOpacity>
                    <View style = {{
                        ...
                        <Image source={ICONS.Version} resizeMode="contain" style = {{
                            flex: 1,
                            width: 20,
                            height: 20
                        }}/>
                ...
                <Item icon={ICONS.Lock} text={'Đổi mật khẩu'} onpress={ () => {
