...
const DataTable = ({data}) => {
  ...
  // Khởi tạo giá trị tổng ban đầu là 0
  const totalNumberOfReports = data
    .slice(1)
...
const MinutesCheckInScreen = ({navigation}) => {
  ...
  return (
    <View style={{flex: 1, marginLeft: 12, marginRight: 12}}>
      <HeaderComponents
        label={'Biên bản kiểm tra tàu nhập Bến'}
        colorIcon={'#333'}
      ...
      <ScrollView>
        ...
        <View
          ...
          <TextInputCusTom
            lable={'Người kiểm tra 1'}
            placeholder={'-Chọn người kiểm tra 1-'}
          />
        </View>
        <View
          style={{
          ...
          <TextInputCusTom
            lable={'Người kiểm tra 2'}
            placeholder={'-Chọn người kiểm tra 2-'}
          />
        </View>
        {/* ====== */}
