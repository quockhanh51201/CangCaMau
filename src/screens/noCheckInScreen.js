...
import { CheckIn, CheckOut, In, NoCheckIn, Out, Waiting, Yes } from "../components/statusComponent"
                        ...
                        <>
                            ...
                            <TouchableOpacity onPress={() => navigation.navigate('')} disabled={true}>
                                <View style = {{
                                    ...
                                    <Text style = {{fontFamily: 'Roboto-Bold', color: '#FFF', fontSize: 14, marginLeft: 8, flex: 12}}>Phiếu thông báo tàu cá nhập cảng</Text>
                            ...
                            <TouchableOpacity onPress={() => navigation.navigate('')} disabled={true}  >
                                <View style = {{
                                    ...
                                    <Text style = {{fontFamily: 'Roboto-Bold', color: '#FFF', fontSize: 14, marginLeft: 8, flex: 12}}>Biên bản nhập bến</Text>
                                    <View style = {{height: 12, width: 12, paddingTop: 1.2, paddingRight: 3.6, paddingBottom: 1.2, paddingLeft: 3, flex: 1}}>
                                        <Image source={ICONS.Next} resizeMode="contain" style = {{height: 12, width: 12, tintColor: '#FFF'}}/>
                                    </View>
                                </View>
                            ...
                            <View style = {{marginLeft: 12, marginBottom: 5, marginTop: 20, flexDirection: 'row'}}>
                                    <Text style = {{ color: '#005F94', fontFamily: 'Roboto-Bold', fontSize: 16}}>
                                        Từ chối xuất bến
                                    </Text>
                            </View>
                            <View style = {{
                                ...
                                <Text style = {{fontFamily: 'Roboto-Regular', fontSize: 16, color: '#005F94'}}>Nhân viên tiếp nhấn</Text>
                                <View style = {{borderBottomWidth: 0.8 , borderBottomColor: '#D6D6D6', paddingBottom: 15}}>
                                    <View style = {{flexDirection: 'row', marginTop: 10}}>
                                        <Image resizeMode="contain" source={ICONS.Profile} style = {{width: 48, height: 48, borderRadius: 48, marginRight: 10}}/>
                                        <View>
                                            <Text style ={{fontFamily: 'Roboto-Bold', fontSize: 16, color: '#333'}}>Lê Văn Kiển</Text>
                                ...
                                <View style = {{marginTop: 15}}>
                                    <Text style = {{fontFamily: 'Roboto-Regular', fontSize: 16, color: '#005F94'}}>Lí do</Text>
                                    <Text style = {{fontFamily: 'Roboto-Regular', fontSize: 16, color: '#333'}}>Tình hình biển động. Yêu cầu chủ tàu không được ra khơi đánh bắt cá trong khoản thời gian từ ngày  10/10/2022 đến 22/10/2022.</Text>
                                </View>
                            </View>
                        </> 
                    )  
